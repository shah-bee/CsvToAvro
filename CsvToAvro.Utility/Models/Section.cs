...
namespace CsvToAvro.Claim
{
    ...
    public partial class Section
    {
        ...
        /// </summary>
        [DataMember]
        public CsvToAvro.Claim.Transaction Transaction { get; set; }
        ...
        public Section(string keyIdPolis, string keyDekkingsNummer, CsvToAvro.Claim.Transaction transaction)
        {
